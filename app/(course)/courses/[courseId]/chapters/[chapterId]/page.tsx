...
import { CouseEnrollButton } from "./_components/course-enroll-button";
...
const ChapterIdPage = async ({ params }: { params: { courseId: string; chapterId: string } }) => {
    ...
    return (
        <div className="">
            ...
            {isLocked && (
                <Banner label="You need to purchase this course for watch this chapter." variant="warning" />
            )}
                ...
                <div>
                    <div className="p-4 flex flex-col md:flex-row items-center justify-between">
                        ...
                        {purchase ? (
                            ...
                            <CouseEnrollButton courseId={params.courseId} price={course.price!} />
                        )}
                    </div>
